...
if(length(commandArgs(trailingOnly = T)) == 0) {
  run_identifier <- "cpynm1_B_uniformis_all4plas_spectratest_260209__08_23"
  print("No costheta_csv given, please add csv-path.")
} else {
...
mean_cos_theta <- arrange(mean_cos_theta, V1)
